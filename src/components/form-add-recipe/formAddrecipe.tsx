...
export function AddRecipeForm ({isVisible}: ModalProps) {
    const visibility = isVisible ? "fixed inset-0 flex items-center justify-center z-50" : "hidden"
        ...
        <section className="max-w-4xl p-6 mx-auto bg-white rounded-md shadow-md dark:bg-gray-800">
            ...
            <form>
                <div className="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                    <div>
                        <main className="text-gray-700 dark:text-gray-200" >Username</main>
                    ...
                    <div>
                        <main className="text-gray-700 dark:text-gray-200" >Email Address</main>
                    ...
                    <div>
                        <main className="text-gray-700 dark:text-gray-200">Password</main>
                    ...
                    <div>
                        <main className="text-gray-700 dark:text-gray-200" >Password Confirmation</main>
                        <input type="password" className="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring"/>
                    </div>
                </div>
